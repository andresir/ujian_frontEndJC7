...
import CartNya from './components/Cart';
import HistoryNya from './components/History';
      ...
      return (
        <div>
          ...
          <div>
            ...
            <Route path="/cart" component={CartNya} />
            <Route path="/history" component={HistoryNya} />
            {/* <Route path="/popokdetail/:id" component={PopokDetail} /> */}

            {/* ini cara query-string */}
